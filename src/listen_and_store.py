...
"""
The callback for when the MQTT client receives a CONNACK response from the MQTT broker. This will
  only run once and is where the MQTT client subscribes to the specified topics from the MQTT
  broker.
"""
...
"""
The callback for when a PUBLISH message is received by the MQTT client from the MQTT broker. This
  will run each time the MQTT client receives sensor data from the MQTT broker and is where the
  recieved data is stored into the MongoDB database.
"""
